...
def main(argv=None):
    ...
    p.add_argument("--use-cce", action="store_true", help="MLXTrainingConfig(use_cce=True)")
    p.add_argument("--compile", action="store_true", help="MLXTrainingConfig(compile=True)")
    p.add_argument("--grad-checkpointing", action="store_true",
                   help="MLXTrainingConfig(gradient_checkpointing=True)")
    p.add_argument("--label-smoothing", type=float, default=0.0,
                   help="MLXTrainingConfig(label_smoothing_factor=...)")
    ...
    with C.JobRecorder(a, backend_hint=None) as rec:
        ...
        if a.label_smoothing:
            cfg["label_smoothing_factor"] = a.label_smoothing
        ...
        config = MLXTrainingConfig(
            ...
            seed=a.seed, use_cce=a.use_cce, compile=a.compile,
