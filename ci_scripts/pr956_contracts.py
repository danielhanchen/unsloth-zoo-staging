...
def main():
    ...
    def kv_bits_trap():
        ...
        try:
            ...
            return f"fast_generate(kv_bits=4) raised TypeError: {exc}"
        raise AssertionError("fast_generate(kv_bits=4) did NOT raise")

    check("fast_generate no longer exposes kv_bits", kv_bits_trap)
